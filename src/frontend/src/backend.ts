...
import type { CommunityStory as _CommunityStory, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCommunityStory(arg0: string, arg1: string, arg2: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCommunityStory(arg0, arg1, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addConsultationSubmission(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addConsultationSubmission(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCommunityStories(): Promise<Array<CommunityStory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCommunityStories();
    ...
    async getAllConsultationSubmissions(): Promise<Array<ConsultationSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllConsultationSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CommunityStory_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CommunityStory): CommunityStory {
...
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CommunityStory>): Array<CommunityStory> {
    return value.map((x)=>from_candid_CommunityStory_n5(_uploadFile, _downloadFile, x));
}
